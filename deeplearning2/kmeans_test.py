...
# Clustering techniques are unsupervised learning algorithms that try to
...
#
# In statistical parlance, we're going to simulate 1500 realizations from
...
#
# While guessing random centroids is fine in theory, most implementations
# use the data itself to identify initial cluster points. This speeds up
# convergence by initializing centroids in the appropriate regime.
